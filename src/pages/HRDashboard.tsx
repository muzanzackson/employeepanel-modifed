...
import HRSideNavigation from "@/components/HRSideNavigation";
...
const HRDashboard = () => {
    ...
    switch (activeTab) {
      ...
      case "employees":
        return selectedEmployee ? (
          ...
          <EmployeeListPanel onSelectEmployee={setSelectedEmployee} />
        );
      case "activity":
        return <EmployeeActivityPanel selectedEmployee={selectedEmployee} />;
      case "analytics":
        return (
          <PerformanceAnalyticsPanel selectedEmployee={selectedEmployee} />
        );
      default:
        return <EmployeeDashboardOverview />;
    }
  ...
  return (
    ...
    >
      <DashboardHeader employeeId="HR Manager" />
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        >
          <div className="h-full glass-card rounded-tl-2xl shadow-2xl border-l border-t border-white/5">
            {renderActivePanel}
          </div>
        </motion.div>
      </div>
